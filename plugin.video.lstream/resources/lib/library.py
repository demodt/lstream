...
class cLibrary:
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.lstream/?function=play&site=cHosterGui&sFileName=' + sFileName + '&sMediaUrl=' + sMediaUrl + '&sHosterIdentifier=' + sHosterIdentifier
        ...
        if sCat == '1':
            ...
            try:
                ...
                cConfig().showInfo('lstream', 'Element rajouté a la librairie')
    ...
    def getLibrary(self):
        xbmc.executebuiltin("Container.Update(special://userdata/addon_data/plugin.video.lstream/)")
        return True
