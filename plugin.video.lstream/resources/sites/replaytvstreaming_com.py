...
SITE_IDENTIFIER = 'replaytlstreaming_com'
SITE_NAME = 'Replay Tv Streaming'
SITE_DESC = 'Replay TV'

URL_MAIN = 'https://replaytlstreaming.com/'
...
def showLinks(page, video):
    sUrl = 'http://replaytlstreaming.com/engine/ajax/re_video_part.php?block=video&page=' + page + '&id=' + video
