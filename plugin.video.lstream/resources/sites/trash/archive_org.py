...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showWeb', '[COLOR gold]Vouz pouvez ajoutez vos films favoris dans la section Cinema plus d infos sur le ghithub lstream[/COLOR]', 'film.jpg', oOutputParameterHandler)
