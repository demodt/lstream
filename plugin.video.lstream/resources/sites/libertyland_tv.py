...
def showMovies(sSearch = ''):
    ...
    if sSearch:
        ...
        if '/series' in sUrl:
            sPattern = '<div class="dilstreaming">.+?<a href="([^"]+)"><strong>([^<]+)<\/strong>.+?<img class="img-responsive".+?src="(.+?)"'
        else:
            sPattern = '<h2 class="heading"> *<a href="[^<>"]+?">([^<]+)<\/a>.+?<img class="img-responsive" *src="([^<]+)" *alt.+?(?:<font color="#00CC00">(.+?)<\/font>.+?)*<div class="dilstreaming"> *<a href="([^<>"]+?)">'
